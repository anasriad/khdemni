...
import { Users, Briefcase, Award, MapPin, Shield, TrendingUp, Menu, X, Search } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <a href="/services" className="text-gray-600 hover:text-yellow-600 px-3 py-2 text-sm font-medium">Services</a>
            <a href="/freelancers" className="text-gray-600 hover:text-yellow-600 px-3 py-2 text-sm font-medium">Find Freelancers</a>
            <a href="/about" className="text-yellow-600 font-medium px-3 py-2 text-sm border-b-2 border-yellow-600">About Us</a>
            <a href="/contact" className="text-gray-600 hover:text-yellow-600 px-3 py-2 text-sm font-medium">Contact</a>
          </nav>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                We prioritize creating a secure platform where both freelancers and clients 
                can transact with confidence, backed by our verification systems.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                We're committed to creating income opportunities and supporting the growth of 
                Morocco's gig economy and small-scale entrepreneurs.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                We build features and policies that support the needs of our Moroccan community, 
                focusing on local context and requirements.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                We encourage high standards through our rating system and provide resources 
                to help our freelancers deliver exceptional service.
              </p>
            </div>
          </div>
        </div>
