            ...
            <nav className=" bg-white border-gray shadow-2xl px-4 lg:px-6 dark:bg-gray-800 border-b-2">
                <div className="flex flex-wrap justify-between items-center max-w-screen-3xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        <a className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800" onClick={()=> navigate("/login")}>Log in</a>
                        ...
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-24 lg:mt-0">
                            ...
                            },
                            {
                                ...
                                <li>
                                    ...
                                    className="cursor-pointer block py-2 pr-4 pl-3 text-black font-bold rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white hover:scale-110 hover:text-green-700 hover:underline hover:underline-offset-8 hover:duration-300"
                                    >
                                    {item.text}
                                    </a>
                                </li>
